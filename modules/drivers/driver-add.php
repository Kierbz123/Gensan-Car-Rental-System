...
<form method="POST" id="driverAddForm" enctype="multipart/form-data" class="needs-validation" novalidate>
    <?= csrfField() ?>
    ...
    <div
        ...
        <div style="display: flex; flex-direction: column; gap: 2rem;">
            <div class="card" style="height: 100%;">
                ...
                <div class="card-body">
                    ...
                    <div
                        style="margin-top:1.5rem;padding:1.5rem;border-radius:12px;background:linear-gradient(to right, var(--bg-muted), transparent);border:1px solid var(--border-color);">
                        <label
                            style="display:block;font-size:.85rem;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:var(--text-color);margin-bottom:1rem;">Profile
                            Photo</label>
                        <div style="display:flex;align-items:center;gap:1.5rem;flex-wrap:wrap;">
                            ...
                            <div style="flex:1;display:flex;flex-direction:column;gap:.75rem;min-width:260px;">
                                <p style="font-size:.8rem;color:var(--text-muted);margin:0;line-height:1.4;">Upload a
                                    clear, recent photo of the driver. This will be used for identification purposes
                                    across the system.</p>
                                <div style="display:flex;gap:.75rem;align-items:center;flex-wrap:wrap;">
                                    ...
                                    <button type="button" onclick="openCamera('profile_photo', 'Take Profile Photo')"
                                        ...
                                        style="padding:.65rem 1.25rem;border-radius:var(--radius-md);display:flex;align-items:center;justify-content:center;gap:8px;font-weight:600;box-shadow:0 4px 6px -1px rgba(0,0,0,0.05);transition:all 0.2s;flex-shrink:0;"
                                        title="Use Camera"
                                ...
                                <div
                                    style="display:flex;align-items:center;gap:6px;font-size:.75rem;color:var(--text-muted);font-weight:500;">
                                    <i data-lucide="info" style="width:14px;height:14px;"></i> JPG, PNG, WebP — max 5 MB
                                </div>
                                <div id="cam_container_profile_photo"
                                    style="display:none; padding:0; border:none; box-shadow:none; background:transparent; align-items:flex-start; margin-top:0.25rem; width:100%;">
        ...
        <div style="display: flex; flex-direction: column; gap: 2rem;">
            ...
            <div class="card" style="flex: 1;">
                ...
                <div class="card-body">
                    <div class="form-group" style="margin-bottom:0; height: 100%;">
                        <textarea id="notes" name="notes" class="form-control" style="height: 100%; min-height: 120px;"
