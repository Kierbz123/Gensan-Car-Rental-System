...
class QRvect
{
    ...
    private static function vectEPS($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $cmyk = false)
    {
        ...
        if ($cmyk) {
            ...
            $c = round((($fore_color & 0xFF000000) >> 24) / 255, 5);
            ...
            // convert color value into decimal eps format
            $c = round((($back_color & 0xFF000000) >> 24) / 255, 5);
            ...
            // convert a hexadecimal color code into decimal eps format (R G B)
            $r = round((($fore_color & 0xFF0000) >> 16) / 255, 5);
            $g = round((($fore_color & 0x00FF00) >> 8) / 255, 5);
            $b = round(($fore_color & 0x0000FF) / 255, 5);
            $fore_color_string = $r . ' ' . $g . ' ' . $b . ' setrgbcolor' . "\n";

            // convert a hexadecimal color code into decimal eps format (R G B)
            $r = round((($back_color & 0xFF0000) >> 16) / 255, 5);
            $g = round((($back_color & 0x00FF00) >> 8) / 255, 5);
            $b = round(($back_color & 0x0000FF) / 255, 5);
            $back_color_string = $r . ' ' . $g . ' ' . $b . ' setrgbcolor' . "\n";
        }
